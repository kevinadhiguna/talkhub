...
const { findUser, createUser, getUsersInRoom, userExists, deleteUser } = require('./utils/database');
        ...
        socket.on('join', async({username, room}, callback) => {
            try {
                ...
                if (userExists.length > 0) {
                    callback(`User ${username} already exists in room ${room}. Please select a different name or room`);
                } else {
